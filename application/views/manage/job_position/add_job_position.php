      ...
      <div class="row">
      	...
      	<?php echo $job_position_tab;?>
      		<div class="col-lg-6 col-lg-offset-3" id="loginform">
      			...
      			<form role="form" action="?d=manage&c=job_position&m=add" method="post" autocomplete="off">
...
<!-- Custom Javascript -->
	...
	$(function(){
		...
		###################################################*/
		<?php 
		if($this->session->flashdata("job_position_message"))
		{?>
			bootbox.alert("<?php echo $this->session->flashdata("job_position_message");?>"); 
		<?php
		}?>
