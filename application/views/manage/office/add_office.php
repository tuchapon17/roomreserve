      ...
      <div class="row">
      	...
      	<?php echo $office_tab;?>
      		<div class="col-lg-6 col-lg-offset-3" id="loginform">
      			...
      			<form role="form" action="?d=manage&c=office&m=add" method="post" autocomplete="off">
...
<!-- Custom Javascript -->
	...
	$(function(){
		...
		###################################################*/
		<?php 
		if($this->session->flashdata("office_message"))
		{?>
			bootbox.alert("<?php echo $this->session->flashdata("office_message");?>"); 
		<?php
		}?>
