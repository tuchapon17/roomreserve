      ...
      <div class="row">
      	...
      	<?php echo $occupation_tab;?>
      		<div class="col-lg-6 col-lg-offset-3" id="loginform">
      			...
      			<form role="form" action="?d=manage&c=occupation&m=add" method="post" autocomplete="off">
...
<!-- Custom Javascript -->
	...
	$(function(){
		...
		###################################################*/
		<?php 
		if($this->session->flashdata("occupation_message"))
		{?>
			bootbox.alert("<?php echo $this->session->flashdata("occupation_message");?>"); 
		<?php
		}?>
