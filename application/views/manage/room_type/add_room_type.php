      ...
      <div class="row">
      	...
      	<?php echo $room_type_tab;?>
      		<div class="col-lg-6 col-lg-offset-3" id="loginform">
      			...
      			<form role="form" action="?d=manage&c=room_type&m=add" method="post">
...
<!-- Custom Javascript -->
	...
	$(function(){
		...
		###################################################*/
		<?php 
		if($this->session->flashdata("room_type_message"))
		{?>
			bootbox.alert("<?php echo $this->session->flashdata("room_type_message");?>"); 
		<?php
		}?>
