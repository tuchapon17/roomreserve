      ...
      <div class="row">
      	...
      	<?php echo $room_type_tab;?>
      		<div class="col-lg-12" id="loginform">
      		 	...
      		 	<form role="form" class="form-inline" action="?d=manage&c=room_type&m=search" method="post" autocomplete="off">
      			...
      			<form role="form" action="?d=manage&c=room_type&m=edit" method="post" autocomplete="off">
